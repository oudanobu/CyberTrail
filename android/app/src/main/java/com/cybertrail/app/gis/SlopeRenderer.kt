...
class SlopeRenderer {
    ...
    companion object {
        // Hex colors with proper alpha transparency block (e.g. #44...)
        ...
        // Color Ints matching the hex values
    ...
    /**
     * Determines high-contrast cyberpunk hex codes for standard MapLibre GeoJson polygon styler:
     * - 0-10°: Green
     * - 10-25°: Yellow
     * - 25-40°: Orange
     * - 40°+: Red
    ...
    /**
     * Determines native ARGB Color Integer values.
     */
